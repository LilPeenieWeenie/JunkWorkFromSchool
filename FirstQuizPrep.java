...
public class FirstQuizPrep extends Application {
   ...
   public void run() {
      /*
         ...
         * a             yes
         * sales         yes
         * sales&profit  no   special character
         * int           no   reserved
         * doubleSales   yes
         * TAX_RATE      yes
         * 1stLetterChar no   has number in first slot
         * char          no   reserved
      * 
      * Given three declared and intilized int variables a, b, and c
      * Which of the following statements are valid?
      *  int a = 5;
      *  int b = 6;
         * a = b;    a would become 6 (valid statemnet)
      *
         * a = 67;                yes
         * b = 8.7;               no  
         * a + b = 8;             no (can only have single identifier)
         * a * b = 12;            no 
         * c = a - b;             yes
         * c = a / 2.3;           no
         * boolean t = a;         no
