...
public class SmileyFaceApp extends Application {
   ...
   public void run() {
      ...
      gc.fillOval(10, 10, 200, 200); // (x, y, x size, y size)

      // draw the eyes
      gc.setFill(Color.BLACK);
      gc.fillOval(55, 65, 30, 30);
      gc.fillOval(135, 65, 30, 30);


      // draw nose
      gc.setFill(Color.RED);
      gc.fillOval(105, 105, 15, 15);

      // draw mouth
      gc.setFill(Color.PURPLE);
      gc.fillOval(55, 120, 120, 60);

      // mouth touchup
      gc.setFill(Color.YELLOW);
      gc.fillRect(55, 120, 120, 30);
      gc.fillOval(55, 120, 120, 50);
