...
public class MilesToKilo extends Application {
   ...
   private void setup() {
      form = new EntryPane("Amount of miles driven");
   ...
   public void run() {
      double miles = Double.parseDouble(form.getField(0));
      double conversion = (double)miles * 1.6093;
      outputln(String.format("%.5f", conversion));
