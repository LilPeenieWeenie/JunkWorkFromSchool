...
public class TypesDemo extends Application {
   ...
   public void run() {
      ...
      int size = 12343456;
      // long
      long TableDiameter = 424948395;
      // float
      float AmmountInWagers = 5999.69f;
      // double *
      double balance = 183574.68;
      // char *
      char LetterF = 'F';
      outputln(Character.getNumericValue(LetterF));
      char num = 29;
      // boolean *
