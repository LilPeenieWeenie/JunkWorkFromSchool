...
public class CurrencyDemo extends Application {
   ...
   private void setup() {
      form = new EntryPane("Enter Product", "Enter Price");
   ...
   public void run() {
      String product = form.getField(0);
      double price = Double.parseDouble(form.getField(1)); // wrapper class Double, Integer, Float....
   
      outputln(String.format("%-30s%7s", product, currency.format(price)));
