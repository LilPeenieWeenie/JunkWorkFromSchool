...
public class DawingForSchol extends Application {
   ...
   public void run() {
      ...
      gc.fillRect(50, 50, 200, 70); 
      // bus hood
      gc.fillRect(250, 85, 50, 35);
      //bus back wheel
      gc.setFill(Color.BLACK);
      gc.fillOval(50, 90, 50, 50);
      gc.setFill(Color.GREY);
      gc.fillOval(60, 100, 30, 30);
      //bus front wheel
      gc.setFill(Color.BLACK);
      gc.fillOval(200, 90, 50, 50);
      gc.setFill(Color.GREY);
      gc.fillOval(210, 100, 30, 30);
      // bus windows
      gc.setFill(Color.GREY);
      gc.fillRect(215, 55, 30, 30);
      gc.fillRect(180, 60, 25, 25);
      gc.fillRect(150, 60, 25, 25);
      gc.fillRect(120, 60, 25, 25);
      gc.fillRect(90, 60, 25, 25);
