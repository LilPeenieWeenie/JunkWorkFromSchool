...
public class LoopsDemo extends Application {
   ...
   public void run() {
      ...
      while(counter > 0) // repeat till condiotion is false
      {
      ...
      // standard for loop
      outputln("\nStandard for loop");
      int max = inputInt("Enter max number of reps");
      for(int i = 0; i < max; i++) //  use i for variable everytime
      {
         outputln(i);
      }
