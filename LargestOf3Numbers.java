...
public class LargestOf3Numbers extends Application {
   ...
   public void run() {
      ...
      // first algorithm
      if(n1 > n2 && n1 > n3)
         outputln(String.format("%d is largest", n1));
      else if(n2 > n3)
         outputln(String.format("%d is largest", n2));
      else
         outputln(String.format("%d is largest", n3));
      ...
      // second algorithm used in loop
      int[] numbers = {4, 66, 77, 349, 1, 99, 33};
      largest = numbers[0];
