...
public class AppBuilderGame extends Application {

   private BorderPane root = new BorderPane();

   private final Button runBtn = new Button("Run Bitch Run!");
   ...
   public void run() {
      ...
      while(true) // Menu loop (outside loop)
      {
         ...
         while(gameVar > 0) // game loop (2nd loop)
         {
            ...
            {
               gameVar -= 20;
               gameStatus = String.format("Game loop variable: %d", gameVar);
            }
            else
               break;
         }
         gameStatus = "Game Over OvO";
