...
public class Java16Demo extends Application {
   ...
   public void run() {
      ...
      // Multiline text box uselful for: SQL, JSON, HTML, XML
     String message = """
      ...
      switch(month){
         ...
         case 10:
         case 12:
            outputln("This month has 31 days");
            break;
         case 4:
         case 6:
         case 9:
            outputln("This month has 30 days");
            break;
         case 2:
            outputln("Febuary can have 28 or 29 days");
            break;
         default:
            outputln("Invalid month");
      
      }
      
      switch(month){
         case 1, 3, 5, 7, 8, 10, 12 -> outputln("This month has 31 days");
         case 4, 6, 9 -> outputln("This month has 30 days");
         case 2 -> {
            int year = Integer.parseInt(input("Enter year"));
            if(year % 4 == 0)
               outputln("This Febuary has 29 days");
            else 
               outputln("This Febuary has 28 days");
         }
         default  -> outputln("Invalid month"); 
      }
