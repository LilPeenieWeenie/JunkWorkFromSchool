...
public class IntegerCalcWithSwitch extends Application {
   ...
   private void setup() {
      form = new EntryPane("1st Integer", "Operator ( + - * / )", "2nd Integer");
   ...
   public void run() {
      int n1 = Integer.parseInt(form.getField(0));
      String operator = form.getField(1);
      int n2 = Integer.parseInt(form.getField(2));
      ...
      switch(operator)
      {
         ...
         case "/":
            ...
            break;
         default:
            showMessage("Please enter a valid operator O_-");    
            ok = false;  
      }
        if(ok)
         outputln(String.format("%d %s %d = %d %s", n1, operator, n2, result, rem));
