...
public class ConditionalDemo extends Application {
   ...
   public void run() {
      ...
      int score = inputInt("Enter a score");
      String grade = "";
      ...
      if(score >= 90 && score <= 100)
         ...
         showMessage("Score is out of range");
      
      outputln(grade);
      
      
      int age = inputInt("Enter an age");
      
      if(age >= 75)
         outputln("You're a bomer");
      else if(age >= 18)
         outputln("You're an adult");
      else if(age >= 13)
         outputln("You're a teenager");
      else
         outputln("You're a kid");
