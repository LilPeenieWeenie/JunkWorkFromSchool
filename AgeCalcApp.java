...
public class AgeCalcApp extends Application {
   ...
   public void run() {
      ...
      int lastBdayYr = Integer.parseInt(form.getField(1));
      int birthYear = Integer.parseInt(form.getField(2));
      
      int age = lastBdayYr - birthYear;
      
      outputln(String.format("Hi %s your last bday was %d and you were born %d, so you are %d years old.",
                                name,               lastBdayYr,         birthYear,         age));
