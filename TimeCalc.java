...
public class TimeCalc extends Application {
   ...
   private void setup() {
      form = new EntryPane("Number of seconds");
   ...
   public void run() {
      int numOfSec = Integer.parseInt(form.getField(0));
      
      int hours = numOfSec / 3600;
      int hoursRemainder = numOfSec % 3600;
      int min = hoursRemainder / 60;
      int sec = hoursRemainder % 60;
      
      outputln(String.format("%d seconds converts to %d hours %d minuits %d seconds", numOfSec, hours, min, sec));  
