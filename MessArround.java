...
public class MessArround extends Application {
   ...
   private Parent createContent() {
      ...
      buttonBox.getChildren().addAll(runBtn, clearBtn, yesBtn, printBtn, list);
   ...
   private void setup() {
      form = new EntryPane("Is this class boring?");
