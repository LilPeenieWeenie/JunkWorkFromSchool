...
public class SkippedEvaluations extends Application {
   ...
   public void run() {
      // Given the following code declaring and initializing two int 
      // variables a and b with respective values 3 and 5 indicate
      // whether the operand ( b < 10 ) will be evaluated.
      
      int a = 3;
      int b = 5;
      
      outputln(a < b || b < 10);  // skipped
      outputln(a != b && b < 10); // not skipped
      outputln(a = 4 || b < 10);  // not skipped
      ouputln(a > b && b < 10);   // skipped
      
      String name = "Larry Henderson";
      String[] names = name.split(" "); 
      
      Math.abs(-3);  // static method (can call just by indicating the class name dont have to define)
