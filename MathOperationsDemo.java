...
public class MathOperationsDemo extends Application {
   ...
   public void run() {
      ...
      n1 = inputInt("Enter age");
      n2 = inputInt("Enter second number");
      
      answer = n1 / n2; // Operators: + - * / %(modulus or remainder op)
      String remainder = "remainder " + n1 % n2;
      
      outputln("You are " + answer + " days old.");
      outputln(String.format("You are %d days old and have %s days leftover", answer, remainder));
