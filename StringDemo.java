...
public class StringDemo extends Application {
   ...
   public void run() {
      // What is a String?
      String name = "Larry B Henderson";
      String[] names = name.split(" ");
      for(String n: names)                // Don't have curley braces because have only one statement have if more
         outputln(n);
      ...
      String message = "This is the time for all good men to come to the aid of their country";
      String[] words = message.split(" ");       
      for(String word: words)
         outputln(word);
      
      outputln(message.length());  // Have to use when fining ammount of characters of a string
      outputln(words.length);      // Don't have to use parenthasies when on arrays finding how many words
