...
public class WageCalc extends Application {
   ...
   private void setup() {
      form = new EntryPane("Name", "Wage", "Hours worked");
   ...
   public void run() {
      ...
      double wage = Double.parseDouble(form.getField(1));
      double hrsWorked = Double.parseDouble(form.getField(2));
      
      double earnings = (double)hrsWorked * wage;
      
      outputln(String.format("%s made $%.2f in %.0f hours.", name, earnings, hrsWorked));
      if(earnings > 300)
         outputln("Nice profit");
      else if(earnings <= 300)
            outputln("Thats just sad");
